...
class VariantSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Variant
        fields = [
            'id', 'product', 'sku', 'attributes', 'base_price', 'compare_at_price', 'cost_price',
            'tax_class', 'weight', 'dimensions', 'is_active', 'images', 'created_at', 'updated_at', 
            'color', 'size'
        ]
    
    def validate_sku(self, value):
        """Ensure that SKU is unique."""
    ...
    def update(self, instance, validated_data):
        """Update a variant with custom logic."""
        ...
        instance.compare_at_price = validated_data.get('compare_at_price', instance.compare_at_price)
        ...
        # Don't forget to update the product if it's in validated_data
...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['id', 'name', 'slug', 'description', 'brand', 'category', 'category_name', 'is_active', 'launch_date', 'variants', 'created_at', 'updated_at']
