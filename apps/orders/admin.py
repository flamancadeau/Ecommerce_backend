...
class CartAdmin(admin.ModelAdmin):
    list_display = ('id_short', 'user_or_session', 'item_count', 'total_value', 
                    'created_at', 'is_expired')
    list_filter = ('created_at', 'expires_at')
    search_fields = ('session_id', 'user_id')
    readonly_fields = ('created_at', 'updated_at', 'is_expired', 'item_count', 'total_value')
...
class OrderItemInline(admin.TabularInline):
    ...
    fields = ('variant', 'quantity', 'unit_price', 'discount_amount', 'tax_amount', 'total_price')

@admin.register(Order)
class OrderAdmin(admin.ModelAdmin):
    list_display = ('order_number', 'customer_email', 'status', 'payment_status', 
...
class ReservationAdmin(admin.ModelAdmin):
    list_display = ('token_short', 'variant_sku', 'warehouse_code', 'quantity', 
                    'status', 'expires_at', 'is_expired', 'has_order')
