...
class IdempotencyKeyAdmin(admin.ModelAdmin):
    list_display = ('key_short', 'status', 'created_at', 'expires_at', 'is_expired', 'has_response')
...
class ScheduledJobAdmin(admin.ModelAdmin):
    list_display = ('job_type', 'scheduled_at', 'executed_at', 'status', 
                    'retry_count', 'is_overdue', 'has_error')
