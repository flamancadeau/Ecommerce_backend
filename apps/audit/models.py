...
class PriceAudit(models.Model):
    ...
    price_book = models.ForeignKey('pricing.PriceBook', on_delete=models.CASCADE, null=True, blank=True)
    price_book_entry = models.ForeignKey('pricing.PriceBookEntry', on_delete=models.SET_NULL, null=True, blank=True)
    old_price = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    new_price = models.DecimalField(max_digits=10, decimal_places=2)
    currency = models.CharField(max_length=3, default='EUR')
    changed_by = models.UUIDField(null=True, blank=True, help_text="User ID who made the change")
